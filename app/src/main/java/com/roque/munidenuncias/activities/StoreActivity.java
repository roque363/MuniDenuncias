...
public class StoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tituloInput = (EditText) findViewById(R.id.txtTitulo);
        descripcionInput = (EditText) findViewById(R.id.txtDescripcion);
        ubicacionInput = (EditText) findViewById(R.id.txtUbicacion);
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(titulo,email, descripcion, ubicacion);
        } else {
            ...
            RequestBody nombrePart = RequestBody.create(MultipartBody.FORM, titulo);
            RequestBody userPart = RequestBody.create(MultipartBody.FORM, email);
            RequestBody desPart = RequestBody.create(MultipartBody.FORM, descripcion);
            RequestBody ubicacionPart = RequestBody.create(MultipartBody.FORM, ubicacion);

            call = service.createDenunciaWithImage(nombrePart, userPart, desPart, ubicacionPart, imagenPart);
        }
            ...
            public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(StoreActivity.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                        finish();
